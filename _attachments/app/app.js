...
// Preload the lesson form definition to enable easier access to form elements.
FORMY.loadForm("lesson", null, {
  success: function(form, resp){
    var lesson = FORMY.forms.get("lesson");
  },
  error: function() {
    console.log("Error loading lesson: " + arguments);
  }
});
...
var AppRouter = Backbone.Router.extend({
  ...
  routes: {
    ...
    "lessonRecords/:lessonId":					"lessonRecords",  // #lessonRecords
...
//      					form.set({"patientMiddle_name": patient.get('Middle_name')});
  ...
  lessonRecords: function (incidentId) {
//    console.log("lessonRecords route.");
    $("#homePageView").remove();
    $("#formRenderingView").remove();
        ...
        record.destroy( {
          success: function(model, response){
            ...
            if (parentId != null) {
              ...
              FORMY.router.navigate('lessonRecords/' + patientId, true);
            } else {
