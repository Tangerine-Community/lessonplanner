...
recordValueNoEscapeCompiledHtml = Handlebars.compile($("#recordValueNoEscape").html());
...
Handlebars.registerHelper("renderValue", function(context) {
	...
	if (inputType == 'text') {
		...
		template = recordValueNoEscapeCompiledHtml;
...
Handlebars.registerHelper('renderAudio', function(value) {
	return '';
	var out = "";
